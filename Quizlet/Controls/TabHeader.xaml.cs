...
namespace Quizlet.Controls
{
    public sealed partial class TabHeader : UserControl
    {
        public Color ColorStroke
        {
            get { return (Color) GetValue(ColorStrokeProperty); }
            set { SetValue(ColorStrokeProperty, value); }
        }

        public static readonly DependencyProperty ColorStrokeProperty = DependencyProperty.Register("ColorStroke",
            typeof (Color), typeof (TabHeader), null);
